...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.DateField","com.vaadin.ui.Window","com.vaadin.ui.CustomComponent","com.vaadin.ui.OptionGroup","com.vaadin.ui.Embedded","com.vaadin.ui.TextArea","com.vaadin.ui.Panel","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.PasswordField","com.vaadin.ui.NativeButton","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Slider","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.Video","com.vaadin.ui.Flash","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.UI","com.vaadin.ui.Table","com.vaadin.ui.Button","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.CustomLayout","com.vaadin.ui.CheckBox","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.FormLayout","com.vaadin.ui.Label","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Link","com.vaadin.ui.InlineDateField","com.vaadin.ui.Audio","com.vaadin.server.FileDownloader","com.vaadin.ui.ProgressBar","com.vaadin.ui.NativeSelect","com.vaadin.ui.Image","com.vaadin.ui.Accordion","com.vaadin.ui.ListSelect","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.JavaScript","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.MenuBar","com.vaadin.ui.CssLayout","com.vaadin.ui.TabSheet","com.vaadin.ui.CustomField","com.vaadin.ui.TwinColSelect","com.vaadin.ui.Upload","com.vaadin.ui.GridLayout","com.vaadin.ui.TreeTable","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.TextField","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Form","com.vaadin.ui.PopupView","com.vaadin.ui.Tree","com.vaadin.ui.ComboBox",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"relativeY", "button", "relativeX", "type", "clientX", "metaKey", "clientY", "ctrlKey", "altKey", "shiftKey", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"registeredEventListeners", "immediate", "styles", "errorMessage", "width", "description", "required", "height", "tabIndex", "hideErrors", "id", "caption", "enabled", "resources", "modified", "readOnly", "primaryStyleName", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"immediate", "tabIndex", "required", "hideErrors", "primaryStyleName", "height", "propertyReadOnly", "caption", "styles", "registeredEventListeners", "id", "width", "readOnly", "resources", "modified", "enabled", "errorMessage", "description", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"resources", "readOnly", "immediate", "caption", "registeredEventListeners", "enabled", "width", "id", "height", "errorMessage", "description", "styles", "primaryStyleName", "alternateText", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"primaryStyleName", "firstChild", "width", "immediate", "resources", "enabled", "description", "errorMessage", "secondChild", "readOnly", "splitterState", "styles", "id", "caption", "height", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"caption", "errorMessage", "height", "propertyReadOnly", "id", "required", "styles", "registeredEventListeners", "tabIndex", "resources", "modified", "description", "primaryStyleName", "immediate", "enabled", "hideErrors", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"readOnly", "width", "description", "registeredEventListeners", "caption", "enabled", "styles", "id", "immediate", "errorMessage", "resources", "height", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"caption", "primaryStyleName", "height", "styles", "id", "readOnly", "registeredEventListeners", "errorMessage", "description", "width", "enabled", "immediate", "resources", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"width", "errorMessage", "spacing", "registeredEventListeners", "marginsBitmask", "enabled", "readOnly", "description", "childData", "immediate", "styles", "id", "height", "resources", "caption", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"required", "enabled", "tabIndex", "styles", "primaryStyleName", "hideErrors", "width", "modified", "height", "propertyReadOnly", "readOnly", "resources", "id", "registeredEventListeners", "immediate", "caption", "errorMessage", "description", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"enabled", "readOnly", "required", "primaryStyleName", "hideErrors", "tabIndex", "modified", "checked", "caption", "styles", "resources", "id", "registeredEventListeners", "immediate", "width", "errorMessage", "height", "description", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"enabled", "resources", "rpcInterfaces", "registeredEventListeners", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"enabled", "id", "readOnly", "height", "caption", "resources", "splitterState", "width", "firstChild", "secondChild", "immediate", "styles", "description", "errorMessage", "registeredEventListeners", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"primaryStyleName", "id", "readOnly", "registeredEventListeners", "width", "immediate", "iconAltText", "enabled", "errorMessage", "description", "tabIndex", "clickShortcutKeyCode", "htmlContentAllowed", "height", "resources", "caption", "disableOnClick", "styles", });
            ...
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"firstDayOfWeek", "name", "pm", "am", "monthNames", "shortMonthNames", "dayNames", "shortDayNames", "twelveHourClock", "dateFormat", "hourMinuteDelimiter", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"errorMessage", "primaryStyleName", "marginsBitmask", "childData", "immediate", "height", "registeredEventListeners", "rows", "styles", "width", "resources", "id", "columns", "caption", "spacing", "description", "readOnly", "enabled", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"resources", "caption", "primaryStyleName", "registeredEventListeners", "spacing", "readOnly", "childData", "enabled", "errorMessage", "height", "styles", "width", "immediate", "id", "marginsBitmask", "description", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"description", "required", "modified", "errorMessage", "rangeStart", "descriptionForAssistiveDevices", "width", "styles", "propertyReadOnly", "immediate", "primaryStyleName", "tabIndex", "id", "enabled", "caption", "registeredEventListeners", "textFieldEnabled", "resources", "hideErrors", "readOnly", "rangeEnd", "height", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionReversed", "position", "maxPositionUnit", "minPositionUnit", "minPosition", "locked", "maxPosition", "positionUnit", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"enabled", "height", "resources", "primaryStyleName", "errorMessage", "readOnly", "caption", "registeredEventListeners", "id", "description", "immediate", "width", "styles", });
            ...
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"enabled", "styles", "tabIndex", "description", "id", "immediate", "resources", "readOnly", "errorMessage", "registeredEventListeners", "width", "height", "caption", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"registeredEventListeners", "readOnly", "description", "width", "errorMessage", "required", "enabled", "maxValue", "caption", "propertyReadOnly", "orientation", "hideErrors", "primaryStyleName", "id", "resolution", "height", "tabIndex", "styles", "modified", "resources", "value", "minValue", "immediate", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"description", "columns", "propertyReadOnly", "caption", "maxLength", "enabled", "readOnly", "height", "primaryStyleName", "id", "immediate", "errorMessage", "hideErrors", "text", "required", "modified", "styles", "registeredEventListeners", "tabIndex", "width", "inputPrompt", "resources", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"parameters", "mode", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"readOnly", "required", "enabled", "tabIndex", "caption", "styles", "modified", "hideErrors", "registeredEventListeners", "width", "errorMessage", "propertyReadOnly", "height", "description", "resources", "immediate", "primaryStyleName", "id", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"id", "resources", "errorMessage", "enabled", "overlayContainerLabel", "height", "tooltipConfiguration", "immediate", "readOnly", "styles", "caption", "loadingIndicatorConfiguration", "primaryStyleName", "localeServiceState", "pollInterval", "width", "pushConfiguration", "description", "tabIndex", "pageState", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"enabled", "connectorToCssPosition", "caption", "height", "errorMessage", "primaryStyleName", "width", "registeredEventListeners", "resources", "styles", "immediate", "readOnly", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"tabIndex", "id", "required", "hideErrors", "modified", "resources", "immediate", "primaryStyleName", "indeterminate", "height", "description", "errorMessage", "styles", "registeredEventListeners", "propertyReadOnly", "enabled", "state", "width", "caption", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"primaryStyleName", "errorMessage", "width", "resizable", "resources", "scrollLeft", "windowMode", "styles", "caption", "description", "immediate", "draggable", "scrollTop", "registeredEventListeners", "modal", "positionX", "tabIndex", "centered", "positionY", "height", "enabled", "readOnly", "resizeLazy", "id", });
            ...
            store.setProperties(java.util.Date.class, new String[] {"year", "date", "time", "seconds", "month", "hours", "minutes", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"resources", "primaryStyleName", "width", "id", "altText", "styles", "readOnly", "showControls", "autoplay", "enabled", "immediate", "caption", "muted", "height", "sourceTypes", "errorMessage", "htmlContentAllowed", "description", "registeredEventListeners", "sources", });
            ...
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"description", "styles", "width", "resources", "childLocations", "enabled", "id", "primaryStyleName", "height", "caption", "templateContents", "readOnly", "immediate", "templateName", "registeredEventListeners", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.ui.PageState.class, new String[] {"hasResizeListeners", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"description", "caption", "registeredEventListeners", "primaryStyleName", "resources", "width", "height", "id", "alternateText", "readOnly", "immediate", "enabled", "errorMessage", "styles", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"width", "resources", "inputPrompt", "height", "text", "required", "modified", "tabIndex", "propertyReadOnly", "hideErrors", "id", "immediate", "columns", "wordwrap", "primaryStyleName", "readOnly", "enabled", "styles", "caption", "description", "errorMessage", "maxLength", "rows", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"enabled", "registeredEventListeners", "styles", "hideErrors", "resources", "description", "errorMessage", "readOnly", "immediate", "primaryStyleName", "height", "tabIndex", "propertyReadOnly", "width", "caption", "required", "modified", "id", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"primaryStyleName", "spacing", "width", "enabled", "childData", "caption", "marginsBitmask", "description", "immediate", "registeredEventListeners", "readOnly", "errorMessage", "styles", "resources", "height", "id", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"enabled", "styles", "id", "callbackNames", "width", "primaryStyleName", "readOnly", "caption", "registeredEventListeners", "errorMessage", "description", "immediate", "resources", "rpcInterfaces", "height", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"registeredEventListeners", "width", "resources", "features", "id", "immediate", "enabled", "height", "primaryStyleName", "styles", "target", "readOnly", "errorMessage", "caption", "parameters", "description", "uriFragment", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"height", "errorMessage", "styles", "enabled", "resources", "registeredEventListeners", "immediate", "primaryStyleName", "caption", "width", "id", "readOnly", "contentMode", "text", "description", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"styles", "enabled", "id", "tabIndex", "height", "resources", "scrollLeft", "caption", "primaryStyleName", "scrollTop", "readOnly", "description", "errorMessage", "registeredEventListeners", "width", "immediate", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"enabled", "showControls", "altText", "sourceTypes", "immediate", "registeredEventListeners", "muted", "styles", "errorMessage", "sources", "id", "primaryStyleName", "autoplay", "resources", "height", "caption", "readOnly", "description", "htmlContentAllowed", "width", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"id", "immediate", "description", "registeredEventListeners", "resources", "rangeStart", "errorMessage", "styles", "modified", "required", "enabled", "propertyReadOnly", "width", "readOnly", "rangeEnd", "tabIndex", "caption", "primaryStyleName", "height", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"resources", "errorMessage", "propertyReadOnly", "layout", "primaryStyleName", "caption", "styles", "hideErrors", "required", "immediate", "tabIndex", "width", "footer", "enabled", "height", "id", "registeredEventListeners", "modified", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"quickOpenDelay", "openDelay", "quickOpenTimeout", "maxWidth", "closeTimeout", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"propertyReadOnly", "id", "description", "height", "primaryStyleName", "registeredEventListeners", "width", "enabled", "pollingInterval", "styles", "immediate", "resources", "caption", "tabIndex", "required", "state", "indeterminate", "modified", "errorMessage", "readOnly", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"disableOnClick", "readOnly", "resources", "errorMessage", "htmlContentAllowed", "registeredEventListeners", "primaryStyleName", "width", "id", "immediate", "height", "iconAltText", "tabIndex", "enabled", "description", "styles", "caption", "clickShortcutKeyCode", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"immediate", "enabled", "description", "height", "primaryStyleName", "html", "caption", "resources", "id", "errorMessage", "readOnly", "registeredEventListeners", "hideOnMouseOut", "styles", "width", });
            ...
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"height", "styles", "readOnly", "resources", "errorMessage", "description", "id", "primaryStyleName", "registeredEventListeners", "caption", "immediate", "childCss", "enabled", "width", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"required", "tabIndex", "immediate", "resources", "enabled", "primaryStyleName", "readOnly", "description", "propertyReadOnly", "height", "id", "errorMessage", "styles", "modified", "registeredEventListeners", "caption", "width", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"width", "immediate", "caption", "alternateText", "description", "enabled", "resources", "readOnly", "registeredEventListeners", "primaryStyleName", "errorMessage", "styles", "height", "id", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"resources", "caption", "id", "height", "archive", "standby", "registeredEventListeners", "primaryStyleName", "immediate", "width", "classId", "errorMessage", "embedParams", "codetype", "readOnly", "description", "alternateText", "styles", "enabled", "codebase", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"index", "dateTo", "description", "timeFrom", "dateFrom", "styleName", "timeTo", "allDay", "caption", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Day.class, new String[] {"date", "localizedDateFormat", "week", "dayOfWeek", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"endDate", "iconKey", "actionKey", "caption", "startDate", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"firstVisibleDayOfWeek", "firstDayOfWeek", "id", "primaryStyleName", "errorMessage", "monthNames", "enabled", "registeredEventListeners", "description", "height", "firstHourOfDay", "scroll", "lastVisibleDayOfWeek", "format24H", "immediate", "caption", "styles", "actions", "days", "readOnly", "events", "resources", "now", "lastHourOfDay", "dayNames", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"enabled", "errorMessage", "height", "styles", "immediate", "id", "registeredEventListeners", "caption", "width", "cursorY", "resources", "cursorX", "description", "primaryStyleName", "bgColor", "readOnly", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"resources", "width", "color", "caption", "immediate", "errorMessage", "readOnly", "primaryStyleName", "popupVisible", "showDefaultCaption", "height", "id", "htmlContentAllowed", "enabled", "styles", "registeredEventListeners", "description", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"height", "errorMessage", "immediate", "id", "rowCount", "enabled", "primaryStyleName", "columnCount", "resources", "description", "registeredEventListeners", "width", "readOnly", "caption", "changedX", "styles", "changedY", "changedColor", });
